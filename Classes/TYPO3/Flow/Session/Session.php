...
class Session implements SessionInterface {
	...
	public function start() {
		...
		if ($this->started === FALSE) {
			...
			$this->sessionCookie = new Cookie($this->sessionCookieName, $this->sessionIdentifier, NULL, $this->sessionCookieLifetime, $this->sessionCookieDomain, $this->sessionCookiePath, $this->sessionCookieSecure, $this->sessionCookieHttpOnly);
	...
	protected function initializeHttpAndCookie(HttpRequestHandlerInterface $requestHandler) {
		...
		if ($this->request->hasCookie($this->sessionCookieName)) {
			...
			$this->sessionCookie = new Cookie($this->sessionCookieName, $sessionIdentifier, NULL, $this->sessionCookieLifetime, $this->sessionCookieDomain, $this->sessionCookiePath, $this->sessionCookieSecure, $this->sessionCookieHttpOnly);
		}
	}
